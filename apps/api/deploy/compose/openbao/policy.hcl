...
# OpenBao token may do. `docs/guides/sessions.md`'s "Auto-unseal with OpenBao" section
...
# `docs/guides/sessions.pt-BR.md` diz o tradeoff sem rodeios — quem consegue ler este único
