...
# OpenBao token may do. `sdk/README.md`'s "Auto-unseal with OpenBao" section
...
# `sdk/README.md` diz o tradeoff sem rodeios — quem consegue ler este único
...
# (`sdk/src/diagnos/session/unseal.py`). No wildcard, no parent path: a
...
# (`sdk/src/diagnos/session/unseal.py`). Sem wildcard, sem path pai: um
